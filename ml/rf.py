...
ship_dir = '/work/mlu/dataset/ship'
sailboat_dir = '/work/mlu/dataset/sailboat'
...
#     images.append(F.to_grayscale(image, num_output_channels=3))

# Pad
images = []
for image in tmp_imgs:
    images.append(F.pad(image, padding=[100, 100, 100, 100], fill=[255, 255, 0]))
...
tmp_imgs = []
for image in images:
    tmp_imgs.append(F.resize(image, (512, 512)))
